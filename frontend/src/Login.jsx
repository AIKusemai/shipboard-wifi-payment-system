  ...
  return (
    <div style={authWrapper}>
      <div style={{...authCard, border: error ? '1px solid #ffeded' : '1px solid transparent'}}>
        ...
        <p style={subtitleStyle}>Sign in to manage your voyages and boarding passes.</p>
        ...
        <p style={footerLinkText}>
          New to VoyagePass? <span onClick={() => navigate("/register")} style={linkBtn}>Create Account</span>
        </p>
      </div>
    </div>
  );
